// This is a copy of gemini.js with modifications for testability
// The implementation is the same, but the dependencies are stubbed
...
// Use our mock GenerativeAI
const genAI = new MockGenerativeAI('mock-api-key');

// Export the main function, identical to the original but using our mocks
...
// Export test helpers to control the mock behavior
export const testHelpers = {
  setResponseText: (text) => {
    mockResponseText = text;
  },
  setShouldThrowError: (value) => {
